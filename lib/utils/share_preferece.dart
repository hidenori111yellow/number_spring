...
class SharedPref{
  ...
  static final android_style = 'android_style';
  ...
  static Future<bool> setAndroidStyle(bool value) => _sharedPreferences.setBool(android_style, value);
  static bool getAndroidStyle() => _sharedPreferences.getBool(android_style) ?? false;
}